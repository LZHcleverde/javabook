...
<div class="container-fluid">
    ...
    <ul role="tablist" class="nav nav-tabs">
        <li <c:if test="${rtype==0 }">class="active"</c:if> role="presentation"><a href="book_list.action?rtype=0">全部商品</a></li>
        <li <c:if test="${rtype==1 }">class="active"</c:if> role="presentation"><a href="book_list.action?rtype=1">条幅推荐</a></li>
        <li <c:if test="${rtype==2 }">class="active"</c:if> role="presentation"><a href="book_list.action?rtype=2">热销推荐</a></li>
        <li <c:if test="${rtype==3 }">class="active"</c:if> role="presentation"><a href="book_list.action?rtype=3">新品推荐</a></li>
    </ul>
        ...
        <c:forEach items="${p }" var="g">
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger" href="book_delete.action?bid=${g.bid}">删除</a>
<%--                    &rtype=${rtype}--%>
                </td>
            </tr>
        </c:forEach>
