...
<div class="container-fluid">
    ...
    <form class="form-horizontal" action="user_update.action" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="input_urealname" value="${u.urealname }"  readonly="readonly">
            </div>
        </div>
        <div class="form-group">
            <label for="input_name" class="col-sm-1 control-label">电话</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="input_uphone" name="uphone" value="${u.uphone }">
            </div>
        </div>
        <div class="form-group">
            <label for="input_name" class="col-sm-1 control-label">地址</label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="input_uaddress" name="uaddress" value="${u.uaddress }">
            </div>
        </div>
        <div class="form-group">
