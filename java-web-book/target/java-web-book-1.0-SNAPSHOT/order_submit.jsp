    ...
    <div class="container">
        ...
        <form class="form-horizontal" action="order_confirm.action" method="post" id="payform">
            <div class="row">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" name="name" value="${usertip.urealname }" style="height:auto;padding:10px;" readonly="readonly" required="required"><br>
                </div>
            </div>
            <div class="row">
                <label class="control-label col-md-1">收货电话</label>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="phone" value="${usertip.uphone }" style="height:auto;padding:10px;" readonly="readonly" required="required"><br>
                </div>
            </div>
            <div class="row">
                <label class="control-label col-md-1">收货地址</label>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="address" value="${usertip.uaddress }" style="height:auto;padding:10px;" readonly="readonly" required="required"><br>
                </div>
            </div>
