    ...
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <h1 class="navbar-brand"><a href="index.action">Web书城</a></h1>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li><a href="/book/index.action" <c:if test="${param.flag==1}">class="active"</c:if>>首页</a></li>
        ...
        <div class="header-info">
            ...
            <div class="header-right cart">
                <a href="book_cart.jsp">
                    <span class="glyphicon glyphicon-shopping-cart <c:if test="${param.flag==8}">active</c:if>" aria-hidden="true"><span class="card_num">
                        <c:choose>
                            <c:when test="${empty order}">0</c:when>
                            <c:otherwise>${order.itemMap.size()}</c:otherwise>
                        </c:choose>
                    </span></span>
                </a>
            </div>
