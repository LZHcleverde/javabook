...
<div class="cart-items">
    <div class="container">
        ...
        <c:if test="${!empty failbook}">
            <c:forEach var="b" items="${failbook}">
                <div class="alert alert-danger">书籍《${b.bname}》，剩余：${b.bstock}本！${failorder }</div>
            </c:forEach>
        </c:if>
    </div>
</div>
...
<div class="cart-items">
    <div class="container">
        ...
        <div class="cart-header col-md-12">
            ...
            <a class="btn btn-success btn-lg" style="margin-left:74%" href="order_submit.action?money=${empty order?0:order.ototal}">提交订单</a>
        </div>
